...
function backKeyDown(e) {
	...
	if ($.mobile.activePage.is('#intro') || $.mobile.activePage.is('#mainPage')) {
		e.preventDefault();
		navigator.app.exitApp();
    } else if ($.mobile.activePage.is('#listPage') || $.mobile.activePage.is('#mediaRecord') || $.mobile.activePage.is('#detailPage')) {
        location.href = 'MediaAPI.html';
	} else {
