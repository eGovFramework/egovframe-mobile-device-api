...
FCMPlugin.prototype.onNotificationReceived = function(payload){
	...
	console.log("Received push notification title ==> " + payload.title);
	console.log("Received push notification message ==> " + payload.message);
	jAlert(payload.message, payload.title, "b");
}
