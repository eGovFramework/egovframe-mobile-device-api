...
function fn_egov_fileDownload(input){
    ...
    var inputtargetPath = cordova.file.documentsDirectory;
    ...
    console.log('>> File Target Path: ' + inputtargetPath);
    ...
    window.plugins.EgovFileOpener.fileDownload(url, params, function(jsondata) {
                                               ...
                                               cordova.plugins.fileOpener2.open(inputtargetPath + inputArray[1],
                                                                                'application/pdf',
                                                                                {
                                                                                    error : function(e) {
                                               ...
                                               resultMsg = result;
                                                    //alert("error > "+result.resultCode);
                                                    alert("error > "+result.resultMsg);
                                               });
