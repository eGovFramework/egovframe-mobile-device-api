...
[Android Studio Developer](https://developer.android.com/studio?hl=ko)</br>

![Android Studio Developer install](./images/androidStudio_install.png)

- 안드로이드 스튜디오 다운로드 (2026.01 기준 - Otter3)
- 다운로드 후 설치까지 진행
- macOS 유저도 Android Studio를 이용해 개발 / 테스트 가능</br> \*설치까지는 동일하나 문제가 있는 경우 [macOS 추가 설정](#3-macos-추가-설정) 참고

### 2) Android SDK 설치 및 설정

- (방법1) 프로그램 설치 간 Android Studio SDK 추가</br>
